...
latest_version_label=$(curl -s -X GET 'https://api.github.com/repos/mattrwi/runner/releases/latest' | jq -r '.tag_name')
...
if [ -f "${runner_file}" ]; then
    ...
    runner_url="https://github.com/mattrwi/runner/releases/download/${latest_version_label}/${runner_file}"
